...
* Do you think it would be easier or harder to search through this data manually or using SQL?-- Definatley easier with SQL once I get to know the language a little better
* What about when the dataset gets larger?-- Then SQL will come in clutch for searching through our data
